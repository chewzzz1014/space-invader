...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship, aliens, bullets):
    # check has any bulletshitalien? If so, get rid of bullet and alien
    collisions = pygame.sprite.groupcollide(bullets, aliens, True, True)

    # group aliens is empty?
    if len(aliens) == 0:
...
def update_aliens(ai_settings, screen, stats, sb, ship, aliens, bullets):
    # check if the fleet is at edge. Update the position of all aliens in fleet
    ...
    # check for alines hitting the bottom of screen
    check_aliens_bottom(ai_settings, screen, stats, sb, ship, aliens, bullets)

def check_fleet_edges(ai_settings, aliens):
    # respond if any alien have reached the edge
...
def check_aliens_bottom(ai_settings, screen, stats, sb, ship, aliens, bullets):
    # check has any alien reach the bottom of the screen
...
def check_high_score(stats, sb):
    # check to see if there's any new high score
